...
const Main = () => {
  return (
    ...
    <div>
  <TextAnimate className='text-white text-4xl max-w-[700px] sm:text-6xl'   animation='scaleUp'>Sua jornada financeira começa aqui. Simples, segura </TextAnimate>
  <TextAnimate className='text-green-500 text-4xl max-w-[500px] sm:text-6xl font-bold mt-8' duration={0.5} animation='slideRight'>e sem complicações.</TextAnimate>
